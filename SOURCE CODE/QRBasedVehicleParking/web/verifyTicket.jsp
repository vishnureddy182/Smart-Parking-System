...
<%
    ...
    try {
        ResultSet rs1 = st1.executeQuery("SELECT * FROM slot_booking where  codeval='" + qrValue + "'");
        System.out.println("Check 1 Pass");
        if (rs1.next()) {
            ResultSet rs = st.executeQuery("SELECT * FROM slot_booking where  codeval='" + qrValue + "' AND ustatus='No'");
            if (rs.next()) {
              //  int l = st2.executeUpdate("update slot_booking set ustatus='Yes' where codeval='" + qrValue + "'  ");
                String codeval = rs.getString("codeval");
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="CheckParking.jsp" class="nav-item nav-link active">Check Parking Ticket</a>
                ...
                <div class="row g-4">
                    <center> <div class="col-md-6">
                            <div class="wow fadeInUp" data-wow-delay="0.2s">
                                <form action="ParkingDetails" method="post">
                                    <div class="row g-3">
                                        <div class="col-12">
...
<%
                ...
                response.sendRedirect("TCHome.jsp?AlreadyUsed");

            }
            rs.close();
        } else {
            response.sendRedirect("TCHome.jsp?Invalid");
        }
