        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="UserDetails.jsp" class="nav-item nav-link">User Details</a>
                    ...
                    <a href="ParkingLogs1.jsp"class="nav-item nav-link">Parking Logs</a>
                ...
                <div class="row g-4">
                    <table id="naresh">
                        ...
                        <%
                            ...
                            try {
                                ResultSet rs = st.executeQuery("SELECT * FROM slot_booking order by id DESC");
                                while (rs.next()) {
