    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="your_bookings.jsp"class="nav-item nav-link active">Your Bookings</a>
                ...
                <div class="col-lg-12">
                                <table id="naresh">
                                    ...
                                    <%
                                        ...
                                        try {
                                            ResultSet rs = st.executeQuery("SELECT * FROM slot_booking WHERE uid = '"+ uid +"' and ustatus='No' order by id DESC");
                                                           while (rs.next()) {
                        ...
                        <tr>
                            ...
                            <td><%=formatTimeAMPM(stime)%></td>
                            <td><%=formatTimeAMPM(endtime)%></td>
                            <td><%=rs.getString("slot_name")%></td>
                            <td><%=rs.getString("time")%></td>
                            <td><%=rs.getString("pcost")%></td>
                                        <td><a href="DownloadTicket.jsp?reqid=<%=rs.getString("id")%>"  class="btn btn-success" style="color: white">&nbsp;Download</a>&nbsp;&nbsp;</td>
                                    </tr>
                                    <%                                        }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
