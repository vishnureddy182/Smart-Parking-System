    ...
    <div class="container-xxl py-5">
        ...
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Users Registration</h1>
            </div>
            <div class="row g-4">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="subject" required="" name="username" placeholder="Name">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="subject" required="" name="dob" placeholder="Date of Birth">
                                        <label for="subject">Date of Birth</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="subject" required="" name="gender" placeholder="Gender">
                                        <label for="subject">Gender</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="subject" required="" name="phone" placeholder="Phone">
                                        <label for="subject">Phone</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="subject" required="" name="address" placeholder="Address">
